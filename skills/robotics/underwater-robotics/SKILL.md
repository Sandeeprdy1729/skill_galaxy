...
description: "Implement Underwater Robotics for robotics and automation systems. Use when developing robot software, implementing control systems, or building autonomous capabilities. This skill covers algorithms, integration, and deployment for underwater robotics."
license: Apache 2.0
tags: ["autonomous", "robotics", "underwater"]
difficulty: advanced
...
### Trigger Phrases
- "Help me implement underwater robotics"
- "How do I build underwater robotics?"
- "Guide me through underwater robotics best practices"
- "Debug my underwater robotics implementation"
- "Optimize my underwater robotics workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require underwater robotics expertise
- Solving problems related to underwater robotics
- Implementing solutions in the robotics domain
- Optimizing existing underwater robotics implementations
- Debugging and troubleshooting underwater robotics issues
...
1. **Core Implementation**: The primary functionality that defines underwater robotics
2. **Supporting Infrastructure**: Systems and services that enable underwater robotics
3. **Integration Points**: How underwater robotics connects with other systems

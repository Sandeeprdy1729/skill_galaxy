---
name: prototyping
description: "Master Prototyping for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for prototyping."
license: Apache 2.0
...
Prototyping represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master prototyping, from foundational concepts to advanced implementation techniques.

Master Prototyping for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for prototyping.

## When to Use This Skill

### Trigger Phrases
- "Help me implement prototyping"
- "How do I build prototyping?"
- "Guide me through prototyping best practices"
- "Debug my prototyping implementation"
- "Optimize my prototyping workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require prototyping expertise
- Solving problems related to prototyping
- Implementing solutions in the product domain
- Optimizing existing prototyping implementations
- Debugging and troubleshooting prototyping issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of prototyping is essential for building robust solutions. The theoretical framework combines concepts from design with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines prototyping
2. **Supporting Infrastructure**: Systems and services that enable prototyping
3. **Integration Points**: How prototyping connects with other systems
...
Before implementing prototyping, ensure you have:
...
```python
# Initial setup for prototyping
class Prototyping:
    """
    Implementation of prototyping with best practices.
    """
...
@dataclass
class Config:
    """Configuration for prototyping."""
    param1: str = "default"
    param2: int = 100
    enabled: bool = True

class AdvancedPrototyping:
    """
    Advanced prototyping implementation with optimization.
...
class TestPrototyping:
    """Test suite for prototyping."""
...
|-------|-------|-------------|
| Understanding Prototyping Fundamentals | Intermediate | Core competency in Understanding prototyping fundamentals |
| Implementing Prototyping Solutions | Intermediate | Core competency in Implementing prototyping solutions |
| Optimizing Prototyping Performance | Intermediate | Core competency in Optimizing prototyping performance |
| Debugging Prototyping Issues | Intermediate | Core competency in Debugging prototyping issues |
| Best Practices For Prototyping | Intermediate | Core competency in Best practices for prototyping |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| jira | Primary tool for prototyping | Advanced |
| figma | Primary tool for prototyping | Advanced |
| amplitude | Primary tool for prototyping | Advanced |
| mixpanel | Primary tool for prototyping | Advanced |
| notion | Primary tool for prototyping | Advanced |
...
Prototyping is an essential skill for professionals working in product. Mastery requires understanding both theoretical foundations and practical implementation techniques.

---
name: user-research
description: "Master User Research for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for user research."
license: Apache 2.0
tags: ["product", "research", "user", "management"]
difficulty: expert
...
User Research represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master user research, from foundational concepts to advanced implementation techniques.

Master User Research for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for user research.

## When to Use This Skill

### Trigger Phrases
- "Help me implement user research"
- "How do I build user research?"
- "Guide me through user research best practices"
- "Debug my user research implementation"
- "Optimize my user research workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require user research expertise
- Solving problems related to user research
- Implementing solutions in the product domain
- Optimizing existing user research implementations
- Debugging and troubleshooting user research issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of user research is essential for building robust solutions. The theoretical framework combines concepts from management with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines user research
2. **Supporting Infrastructure**: Systems and services that enable user research
3. **Integration Points**: How user research connects with other systems
...
Before implementing user research, ensure you have:
...
```python
# Initial setup for user research
class User_Research:
    """
    Implementation of user research with best practices.
    """
...
@dataclass
class Config:
    """Configuration for user research."""
    param1: str = "default"
    param2: int = 100
    enabled: bool = True

class AdvancedUserresearch:
    """
    Advanced user research implementation with optimization.
...
class TestUserresearch:
    """Test suite for user research."""
...
|-------|-------|-------------|
| Understanding User Research Fundamentals | Intermediate | Core competency in Understanding user research fundamentals |
| Implementing User Research Solutions | Intermediate | Core competency in Implementing user research solutions |
| Optimizing User Research Performance | Intermediate | Core competency in Optimizing user research performance |
| Debugging User Research Issues | Intermediate | Core competency in Debugging user research issues |
| Best Practices For User Research | Intermediate | Core competency in Best practices for user research |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| jira | Primary tool for user research | Advanced |
| figma | Primary tool for user research | Advanced |
| amplitude | Primary tool for user research | Advanced |
| mixpanel | Primary tool for user research | Advanced |
| notion | Primary tool for user research | Advanced |
...
User Research is an essential skill for professionals working in product. Mastery requires understanding both theoretical foundations and practical implementation techniques.

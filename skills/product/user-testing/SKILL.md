---
name: user-testing
description: "Master User Testing for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for user testing."
license: Apache 2.0
...
User Testing represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master user testing, from foundational concepts to advanced implementation techniques.

Master User Testing for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for user testing.

## When to Use This Skill

### Trigger Phrases
- "Help me implement user testing"
- "How do I build user testing?"
- "Guide me through user testing best practices"
- "Debug my user testing implementation"
- "Optimize my user testing workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require user testing expertise
- Solving problems related to user testing
- Implementing solutions in the product domain
- Optimizing existing user testing implementations
- Debugging and troubleshooting user testing issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of user testing is essential for building robust solutions. The theoretical framework combines concepts from design with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines user testing
2. **Supporting Infrastructure**: Systems and services that enable user testing
3. **Integration Points**: How user testing connects with other systems
...
Before implementing user testing, ensure you have:
...
```python
# Initial setup for user testing
class User_Testing:
    """
    Implementation of user testing with best practices.
    """
...
class AdvancedUsertesting:
    """
    Advanced user testing implementation with optimization.
...
class TestUsertesting:
    """Test suite for user testing."""
...
|-------|-------|-------------|
| Understanding User Testing Fundamentals | Intermediate | Core competency in Understanding user testing fundamentals |
| Implementing User Testing Solutions | Intermediate | Core competency in Implementing user testing solutions |
| Optimizing User Testing Performance | Intermediate | Core competency in Optimizing user testing performance |
| Debugging User Testing Issues | Intermediate | Core competency in Debugging user testing issues |
| Best Practices For User Testing | Intermediate | Core competency in Best practices for user testing |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| jira | Primary tool for user testing | Advanced |
| figma | Primary tool for user testing | Advanced |
| amplitude | Primary tool for user testing | Advanced |
| mixpanel | Primary tool for user testing | Advanced |
| notion | Primary tool for user testing | Advanced |
...
User Testing is an essential skill for professionals working in product. Mastery requires understanding both theoretical foundations and practical implementation techniques.

---
name: design-systems
description: "Master Design Systems for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for design systems."
license: Apache 2.0
...
Design Systems represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master design systems, from foundational concepts to advanced implementation techniques.

Master Design Systems for product management and development. Use when building products, managing roadmaps, or driving growth. This skill covers strategies, frameworks, and best practices for design systems.

## When to Use This Skill

### Trigger Phrases
- "Help me implement design systems"
- "How do I build design systems?"
- "Guide me through design systems best practices"
- "Debug my design systems implementation"
- "Optimize my design systems workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require design systems expertise
- Solving problems related to design systems
- Implementing solutions in the product domain
- Optimizing existing design systems implementations
- Debugging and troubleshooting design systems issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of design systems is essential for building robust solutions. The theoretical framework combines concepts from design with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines design systems
2. **Supporting Infrastructure**: Systems and services that enable design systems
3. **Integration Points**: How design systems connects with other systems
...
Before implementing design systems, ensure you have:
...
```python
# Initial setup for design systems
class Design_Systems:
    """
    Implementation of design systems with best practices.
    """
...
@dataclass
class Config:
    """Configuration for design systems."""
    param1: str = "default"
    param2: int = 100
    enabled: bool = True

class AdvancedDesignsystems:
    """
    Advanced design systems implementation with optimization.
...
class TestDesignsystems:
    """Test suite for design systems."""
    
    def test_initialization(self):
        """Test proper initialization."""
        system = Designsystems()
...
|-------|-------|-------------|
| Understanding Design Systems Fundamentals | Intermediate | Core competency in Understanding design systems fundamentals |
| Implementing Design Systems Solutions | Intermediate | Core competency in Implementing design systems solutions |
| Optimizing Design Systems Performance | Intermediate | Core competency in Optimizing design systems performance |
| Debugging Design Systems Issues | Intermediate | Core competency in Debugging design systems issues |
| Best Practices For Design Systems | Intermediate | Core competency in Best practices for design systems |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| jira | Primary tool for design systems | Advanced |
| figma | Primary tool for design systems | Advanced |
| amplitude | Primary tool for design systems | Advanced |
| mixpanel | Primary tool for design systems | Advanced |
| notion | Primary tool for design systems | Advanced |
...
Design Systems is an essential skill for professionals working in product. Mastery requires understanding both theoretical foundations and practical implementation techniques.

...
description: "Implement Security Controls for cybersecurity and information security. Use when securing systems, conducting security assessments, or building defensive capabilities. This skill covers security principles, implementation strategies, and operational best practices for security controls."
license: Apache 2.0
tags: ["defensive", "security", "controls"]
...
1. **Core Implementation**: The primary functionality that defines security controls
2. **Supporting Infrastructure**: Systems and services that enable security controls
3. **Integration Points**: How security controls connects with other systems

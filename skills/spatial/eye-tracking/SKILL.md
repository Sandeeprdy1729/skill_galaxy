---
name: eye-tracking
description: "Develop Eye Tracking for spatial computing and immersive experiences. Use when building AR/VR applications, developing 3D graphics, or creating spatial interfaces. This skill covers development techniques, optimization strategies, and platform considerations."
license: Apache 2.0
tags: ["tracking", "spatial", "ar-vr", "eye"]
difficulty: expert
...
Eye Tracking represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master eye tracking, from foundational concepts to advanced implementation techniques.

Develop Eye Tracking for spatial computing and immersive experiences. Use when building AR/VR applications, developing 3D graphics, or creating spatial interfaces. This skill covers development techniques, optimization strategies, and platform considerations.

## When to Use This Skill

### Trigger Phrases
- "Help me implement eye tracking"
- "How do I build eye tracking?"
- "Guide me through eye tracking best practices"
- "Debug my eye tracking implementation"
- "Optimize my eye tracking workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require eye tracking expertise
- Solving problems related to eye tracking
- Implementing solutions in the spatial domain
- Optimizing existing eye tracking implementations
- Debugging and troubleshooting eye tracking issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of eye tracking is essential for building robust solutions. The theoretical framework combines concepts from ar-vr with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines eye tracking
2. **Supporting Infrastructure**: Systems and services that enable eye tracking
3. **Integration Points**: How eye tracking connects with other systems
...
Before implementing eye tracking, ensure you have:
...
```python
# Initial setup for eye tracking
class Eye_Tracking:
    """
    Implementation of eye tracking with best practices.
    """
...
class AdvancedEyetracking:
    """
    Advanced eye tracking implementation with optimization.
...
|-------|-------|-------------|
| Understanding Eye Tracking Fundamentals | Intermediate | Core competency in Understanding eye tracking fundamentals |
| Implementing Eye Tracking Solutions | Intermediate | Core competency in Implementing eye tracking solutions |
| Optimizing Eye Tracking Performance | Intermediate | Core competency in Optimizing eye tracking performance |
| Debugging Eye Tracking Issues | Intermediate | Core competency in Debugging eye tracking issues |
| Best Practices For Eye Tracking | Intermediate | Core competency in Best practices for eye tracking |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| unity | Primary tool for eye tracking | Advanced |
| unreal | Primary tool for eye tracking | Advanced |
| threejs | Primary tool for eye tracking | Advanced |
| webxr | Primary tool for eye tracking | Advanced |
| arcore | Primary tool for eye tracking | Advanced |
...
Eye Tracking is an essential skill for professionals working in spatial. Mastery requires understanding both theoretical foundations and practical implementation techniques.

---
name: game-physics
description: "Develop Game Physics for spatial computing and immersive experiences. Use when building AR/VR applications, developing 3D graphics, or creating spatial interfaces. This skill covers development techniques, optimization strategies, and platform considerations."
license: Apache 2.0
tags: ["game", "game-dev", "spatial", "physics"]
...
Game Physics represents a critical skill in the modern technology landscape. This comprehensive guide provides everything you need to master game physics, from foundational concepts to advanced implementation techniques.

Develop Game Physics for spatial computing and immersive experiences. Use when building AR/VR applications, developing 3D graphics, or creating spatial interfaces. This skill covers development techniques, optimization strategies, and platform considerations.

## When to Use This Skill

### Trigger Phrases
- "Help me implement game physics"
- "How do I build game physics?"
- "Guide me through game physics best practices"
- "Debug my game physics implementation"
- "Optimize my game physics workflow"

### Applicable Scenarios
This skill is essential when:
- Building systems that require game physics expertise
- Solving problems related to game physics
- Implementing solutions in the spatial domain
- Optimizing existing game physics implementations
- Debugging and troubleshooting game physics issues

## Core Concepts

### Foundation Principles

Understanding the fundamental principles of game physics is essential for building robust solutions. The theoretical framework combines concepts from game-dev with practical implementation patterns.
...
1. **Core Implementation**: The primary functionality that defines game physics
2. **Supporting Infrastructure**: Systems and services that enable game physics
3. **Integration Points**: How game physics connects with other systems
...
Before implementing game physics, ensure you have:
...
```python
# Initial setup for game physics
class Game_Physics:
    """
    Implementation of game physics with best practices.
    """
...
class AdvancedGamephysics:
    """
    Advanced game physics implementation with optimization.
...
|-------|-------|-------------|
| Understanding Game Physics Fundamentals | Intermediate | Core competency in Understanding game physics fundamentals |
| Implementing Game Physics Solutions | Intermediate | Core competency in Implementing game physics solutions |
| Optimizing Game Physics Performance | Intermediate | Core competency in Optimizing game physics performance |
| Debugging Game Physics Issues | Intermediate | Core competency in Debugging game physics issues |
| Best Practices For Game Physics | Intermediate | Core competency in Best practices for game physics |

## Tools and Technologies

| Tool | Purpose | Level |
|------|---------|-------|
| unity | Primary tool for game physics | Advanced |
| unreal | Primary tool for game physics | Advanced |
| threejs | Primary tool for game physics | Advanced |
| webxr | Primary tool for game physics | Advanced |
| arcore | Primary tool for game physics | Advanced |
...
Game Physics is an essential skill for professionals working in spatial. Mastery requires understanding both theoretical foundations and practical implementation techniques.
